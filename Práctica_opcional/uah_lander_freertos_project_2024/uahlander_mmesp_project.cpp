...
int main (void){
	...
	UAHLander	comp1(1, 13, EDROOMprioNormal, 1024, systemDeployment.GetComp1Memory());
	CCLanderManager	comp2(2, 11, EDROOMprioNormal, 1024, systemDeployment.GetComp2Memory());
	...
	CCHorizVelCtrl	comp6(6, 14, EDROOMprioVeryHigh, 1024, systemDeployment.GetComp6Memory());
