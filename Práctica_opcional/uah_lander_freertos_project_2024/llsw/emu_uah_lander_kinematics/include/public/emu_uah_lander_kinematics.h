...
class UAHLanderEmuKinematic {

	//Veloc
	struct UAHLanderKinematic mExpKinematic;
...
public:
	...
	UAHLanderKinematic EmuKinematic(float Fx_Ti_1, float Fy_Ti_1, float Fz_Ti_1);
