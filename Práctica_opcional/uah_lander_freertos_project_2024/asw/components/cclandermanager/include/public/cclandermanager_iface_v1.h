#ifndef CCLANDERMANAGER_H_
#define CCLANDERMANAGER_H_
...
/**
 * \class   CCLanderManager
 *
 */
class CCLanderManager: public CEDROOMComponent {

public:

	/**
	 * \enum TEDROOMCCLanderManagerSignal
	 * \brief Component Signal Enum Type
	 *
	 */
	 enum TEDROOMCCLanderManagerSignal { EDROOMSignalTimeout, 
							EDROOMSignalDestroy, 
							SHVCtrlTC, 
							EDROOMIRQsignal, 
							SBKGTC, 
	...
	/**
	 * \class CCLanderManager::CEDROOMMemory
	...
	//! HVControl Component Port
	CEDROOMInterface	HVControl;
	...
	//! Constructor
	CCLanderManager(TEDROOMComponentID id, TEDROOMUInt32 roomNumMaxMens, TEDROOMPriority roomtaskPrio, 
...
public:
	...
	enum TEDROOMCCLanderManagerSignal { EDROOMSignalTimeout,
		...
		friend class CCLanderManager;

		//!component reference
		CCLanderManager &EDROOMcomponent;
		...
		//!Constructor
		EDROOM_CTX_Top_0 (CCLanderManager &act,
	...
	public:
		...
		//! Constructor
		EDROOM_SUB_Top_0 (CCLanderManager &act, CEDROOMMemory *pEDROOMMemory  );
