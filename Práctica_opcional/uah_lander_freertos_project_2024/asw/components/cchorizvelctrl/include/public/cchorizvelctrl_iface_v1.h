#ifndef CCHORIZVELCTRL_H_
#define CCHORIZVELCTRL_H_
...
/**
 * \class   CCHorizVelCtrl
 *
 */
class CCHorizVelCtrl: public CEDROOMComponent {

public:

	/**
	 * \enum TEDROOMCCHorizVelCtrlSignal
	 * \brief Component Signal Enum Type
	 *
	 */
	 enum TEDROOMCCHorizVelCtrlSignal { EDROOMSignalTimeout, 
							EDROOMSignalDestroy, 
							SHVCtrlTC, 
							STxTM, 
							STMQueued };
	...
	/**
	 * \class CCHorizVelCtrl::CEDROOMMemory
	...
	//! Constructor
	CCHorizVelCtrl(TEDROOMComponentID id, TEDROOMUInt32 roomNumMaxMens, TEDROOMPriority roomtaskPrio, 
...
public:
	...
	enum TEDROOMCCHorizVelCtrlSignal { EDROOMSignalTimeout,
		...
		friend class CCHorizVelCtrl;

		//!component reference
		CCHorizVelCtrl &EDROOMcomponent;
		...
		//!Constructor
		EDROOM_CTX_Top_0 (CCHorizVelCtrl &act,
	...
	public:
		...
		//! Constructor
		EDROOM_SUB_Top_0 (CCHorizVelCtrl &act, CEDROOMMemory *pEDROOMMemory  );
