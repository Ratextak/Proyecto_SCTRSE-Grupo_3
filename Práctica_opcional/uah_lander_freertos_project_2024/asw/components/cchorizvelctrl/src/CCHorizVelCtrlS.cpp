...
CCHorizVelCtrl::CCHorizVelCtrl(TEDROOMComponentID id,
...
int CCHorizVelCtrl::EDROOMConfig()
{
...
int CCHorizVelCtrl::EDROOMStart()
{
...
void CCHorizVelCtrl::EDROOMBehaviour()
{
...
bool CCHorizVelCtrl::EDROOMIsComponentFinished()
{
...
void CCHorizVelCtrl::CEDROOMMemory::SetMemory(TEDROOMUInt32 numMessages_ ,
