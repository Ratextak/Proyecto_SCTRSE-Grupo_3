 ...
 *
 */
class UAHLander: public CEDROOMComponent {

public:

	/**
	 * \enum TEDROOMUAHLanderSignal
	 * \brief Component Signal Enum Type
	 *
	 */
	 enum TEDROOMUAHLanderSignal { EDROOMSignalTimeout, 
							EDROOMSignalDestroy };

	/**
	 * \class UAHLander::CEDROOMMemory
	...
	//! Constructor
	UAHLander(TEDROOMComponentID id, TEDROOMUInt32 roomNumMaxMens, TEDROOMPriority roomtaskPrio, 
...
public:
	...
	enum TEDROOMUAHLanderSignal { EDROOMSignalTimeout,
		...
		friend class UAHLander;

		//!component reference
		UAHLander &EDROOMcomponent;
		...
		//!Constructor
		EDROOM_CTX_Top_0 (UAHLander &act,
	...
	public:
		...
		//! Constructor
		EDROOM_SUB_Top_0 (UAHLander &act );
