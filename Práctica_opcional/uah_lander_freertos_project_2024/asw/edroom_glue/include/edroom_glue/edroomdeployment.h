...
//!Conections
	...
	UAHLander   * mp_comp1;
	CCLanderManager   * mp_comp2;
	CCTM_ChannelCtrl   * mp_comp3;
	CCHK_FDIRMng   * mp_comp4;
	CCBKGTCExec   * mp_comp5;
	CCHorizVelCtrl   * mp_comp6;
 
 
//!Set Components
 
	void SetComponents(UAHLander   *p_comp1,
...
//Signal Conversion
	...
	static TEDROOMSignal C6HorizVelCtrl_PTMChannelCtrl__C3TM_ChannelCtrl_PTMChannelCtrl4(TEDROOMSignal signal);
	static TEDROOMSignal C3TM_ChannelCtrl_PTMChannelCtrl4__C6HorizVelCtrl_PTMChannelCtrl(TEDROOMSignal signal);
 
//Signal Conversion
 
	static TEDROOMSignal C2LanderManager_PHVControl__C6HorizVelCtrl_PHVControl(TEDROOMSignal signal);
	static TEDROOMSignal C6HorizVelCtrl_PHVControl__C2LanderManager_PHVControl(TEDROOMSignal signal);
 
//Signal Conversion
 
	static TEDROOMSignal C3TM_ChannelCtrl_PTMChannelCtrl__C2LanderManager_PTMChannelCtrl(TEDROOMSignal signal);
	static TEDROOMSignal C2LanderManager_PTMChannelCtrl__C3TM_ChannelCtrl_PTMChannelCtrl(TEDROOMSignal signal);
 
//Signal Conversion
 
	static TEDROOMSignal C5BKGTCExec_PBKGExecCtrl__C2LanderManager_PBKGExecCtrl(TEDROOMSignal signal);
	static TEDROOMSignal C2LanderManager_PBKGExecCtrl__C5BKGTCExec_PBKGExecCtrl(TEDROOMSignal signal);
...
//Signal Conversion
	...
	static TEDROOMSignal C4HK_FDIRMng_PHK_FDIRCtrl__C2LanderManager_PHK_FDIRCtrl(TEDROOMSignal signal);
	static TEDROOMSignal C2LanderManager_PHK_FDIRCtrl__C4HK_FDIRMng_PHK_FDIRCtrl(TEDROOMSignal signal);
...
//!Config Components
	...
	UAHLander::CEDROOMMemory 		* GetComp1Memory(){return &systemMemory.comp1Memory;}
	CCLanderManager::CEDROOMMemory 		* GetComp2Memory(){return &systemMemory.comp2Memory;}
	...
	CCHorizVelCtrl::CEDROOMMemory 		* GetComp6Memory(){return &systemMemory.comp6Memory;}
