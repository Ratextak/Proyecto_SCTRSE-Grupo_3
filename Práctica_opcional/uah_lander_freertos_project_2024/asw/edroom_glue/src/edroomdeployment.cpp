...
void MainWait(UAHLander   &comp1,
					CCLanderManager   &comp2,
					CCTM_ChannelCtrl   &comp3,
					CCHK_FDIRMng   &comp4,
					CCBKGTCExec   &comp5,
					CCHorizVelCtrl   &comp6){
...
void CEDROOMSystemCommSAP::SetComponents(UAHLander   *p_comp1,
										CCLanderManager   *p_comp2,
										CCTM_ChannelCtrl   *p_comp3,
										CCHK_FDIRMng   *p_comp4,
										CCBKGTCExec   *p_comp5,
										CCHorizVelCtrl   *p_comp6){
	mp_comp1=p_comp1;
	mp_comp2=p_comp2;
	mp_comp3=p_comp3;
	mp_comp4=p_comp4;
...
TEDROOMSignal CEDROOMSystemCommSAP::C6HorizVelCtrl_PTMChannelCtrl__C3TM_ChannelCtrl_PTMChannelCtrl4(TEDROOMSignal signalOut){
 
	TEDROOMSignal signalIn;
 
	switch(signalOut){
 
		case( CCHorizVelCtrl::STxTM):	 signalIn=CCTM_ChannelCtrl::STxTM; break;
...
TEDROOMSignal CEDROOMSystemCommSAP::C3TM_ChannelCtrl_PTMChannelCtrl4__C6HorizVelCtrl_PTMChannelCtrl(TEDROOMSignal signalOut){
 
	TEDROOMSignal signalIn;
 
	switch(signalOut){
 
		case( CCTM_ChannelCtrl::STMQueued):	 signalIn=CCHorizVelCtrl::STMQueued; break;
...
TEDROOMSignal CEDROOMSystemCommSAP::C2LanderManager_PHVControl__C6HorizVelCtrl_PHVControl(TEDROOMSignal signalOut){
 
	TEDROOMSignal signalIn;
 
	switch(signalOut){
 
		case( CCLanderManager::SHVCtrlTC):	 signalIn=CCHorizVelCtrl::SHVCtrlTC; break;
...
TEDROOMSignal CEDROOMSystemCommSAP::C6HorizVelCtrl_PHVControl__C2LanderManager_PHVControl(TEDROOMSignal signalOut){
...
TEDROOMSignal CEDROOMSystemCommSAP::C3TM_ChannelCtrl_PTMChannelCtrl__C2LanderManager_PTMChannelCtrl(TEDROOMSignal signalOut){
 
	TEDROOMSignal signalIn;
 
	switch(signalOut){
 
		case( CCTM_ChannelCtrl::STMQueued):	 signalIn=CCLanderManager::STMQueued; break;
...
TEDROOMSignal CEDROOMSystemCommSAP::C2LanderManager_PTMChannelCtrl__C3TM_ChannelCtrl_PTMChannelCtrl(TEDROOMSignal signalOut){
 
	TEDROOMSignal signalIn;
 
	switch(signalOut){
 
		case( CCLanderManager::STxTM):	 signalIn=CCTM_ChannelCtrl::STxTM; break;
...
TEDROOMSignal CEDROOMSystemCommSAP::C5BKGTCExec_PBKGExecCtrl__C2LanderManager_PBKGExecCtrl(TEDROOMSignal signalOut){
...
TEDROOMSignal CEDROOMSystemCommSAP::C2LanderManager_PBKGExecCtrl__C5BKGTCExec_PBKGExecCtrl(TEDROOMSignal signalOut){
 
	TEDROOMSignal signalIn;
 
	switch(signalOut){
 
		case( CCLanderManager::SBKGTC):	 signalIn=CCBKGTCExec::SBKGTC; break;
...
TEDROOMSignal CEDROOMSystemCommSAP::C4HK_FDIRMng_PHK_FDIRCtrl__C2LanderManager_PHK_FDIRCtrl(TEDROOMSignal signalOut){
...
TEDROOMSignal CEDROOMSystemCommSAP::C2LanderManager_PHK_FDIRCtrl__C4HK_FDIRMng_PHK_FDIRCtrl(TEDROOMSignal signalOut){
 
	TEDROOMSignal signalIn;
 
	switch(signalOut){
 
		case( CCLanderManager::SHK_FDIR_TC):	 signalIn=CCHK_FDIRMng::SHK_FDIR_TC; break;
...
void CEDROOMSystemCommSAP::RegisterInterfaces(){
	...
	m_localCommSAP.RegisterInterface(1, mp_comp2->HVControl, mp_comp2);
	...
	m_localCommSAP.RegisterInterface(2, mp_comp6->HVControl, mp_comp6);
...
void CEDROOMSystemCommSAP::SetLocalConnections(){
	...
	m_localCommSAP.Connect(mp_comp6->TMChannelCtrl, mp_comp3->TMChannelCtrl4, connections[0], 
					C6HorizVelCtrl_PTMChannelCtrl__C3TM_ChannelCtrl_PTMChannelCtrl4, 
					C3TM_ChannelCtrl_PTMChannelCtrl4__C6HorizVelCtrl_PTMChannelCtrl);
 
	m_localCommSAP.Connect(mp_comp2->HVControl, mp_comp6->HVControl, connections[1], 
					C2LanderManager_PHVControl__C6HorizVelCtrl_PHVControl, 
					C6HorizVelCtrl_PHVControl__C2LanderManager_PHVControl);
 
	m_localCommSAP.Connect(mp_comp3->TMChannelCtrl, mp_comp2->TMChannelCtrl, connections[2], 
					C3TM_ChannelCtrl_PTMChannelCtrl__C2LanderManager_PTMChannelCtrl, 
					C2LanderManager_PTMChannelCtrl__C3TM_ChannelCtrl_PTMChannelCtrl);
 
	m_localCommSAP.Connect(mp_comp5->BKGExecCtrl, mp_comp2->BKGExecCtrl, connections[3], 
					C5BKGTCExec_PBKGExecCtrl__C2LanderManager_PBKGExecCtrl, 
					C2LanderManager_PBKGExecCtrl__C5BKGTCExec_PBKGExecCtrl);
 
	m_localCommSAP.Connect(mp_comp3->TMChannelCtrl3, mp_comp5->TMChannelCtrl, connections[4], 
					C3TM_ChannelCtrl_PTMChannelCtrl3__C5BKGTCExec_PTMChannelCtrl, 
					C5BKGTCExec_PTMChannelCtrl__C3TM_ChannelCtrl_PTMChannelCtrl3);
 
	m_localCommSAP.Connect(mp_comp4->TMChannelCtrl, mp_comp3->TMChannelCtrl2, connections[5], 
	...
	m_localCommSAP.Connect(mp_comp4->HK_FDIRCtrl, mp_comp2->HK_FDIRCtrl, connections[6], 
					C4HK_FDIRMng_PHK_FDIRCtrl__C2LanderManager_PHK_FDIRCtrl, 
					C2LanderManager_PHK_FDIRCtrl__C4HK_FDIRMng_PHK_FDIRCtrl);
...
void CEDROOMSystemDeployment::Config(UAHLander   *p_comp1,
											CCLanderManager   *p_comp2,
											CCTM_ChannelCtrl   *p_comp3,
											CCHK_FDIRMng   *p_comp4,
											CCBKGTCExec   *p_comp5,
