...
enum TTCExecCtrl {
	ExecCtrlPrioTC, ExecCtrlReboot,ExecCtrlHK_FDIRTC,ExecCtrlBKGTC,ExecCtrlHorizVelCtrlTC
};
...
protected:
	...
	/**
	 * \brief Set mTCExecCtrl to ExecCtrlHorizVelCtrlTC
	 *
	 */

	void SetExecCtrlAsHorizVelCtrlTC() {

		mTCExecCtrl = ExecCtrlHorizVelCtrlTC;
	}
...
public:
	...
	bool_t IsHorizVelCtrlTC() {
			return ExecCtrlHorizVelCtrlTC == mTCExecCtrl;
	}
