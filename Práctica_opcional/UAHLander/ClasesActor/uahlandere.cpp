...
UAHLander::UAHLander(TEDROOMComponentID id,
...
void UAHLander::EDROOMBehaviour()
{
...
bool UAHLander::EDROOMIsComponentFinished()
{


	return ( LanderManager.EDROOMIsComponentFinished() && TM_ChannelCtrl.EDROOMIsComponentFinished() && HK_FDIRMng.EDROOMIsComponentFinished() && BKGTCExec.EDROOMIsComponentFinished() && HorizVelCtrl.EDROOMIsComponentFinished() && CEDROOMComponent::EDROOMIsComponentFinished());
...
void UAHLander::CEDROOMMemory::SetMemory(TEDROOMUInt32 numMessages_ ,
