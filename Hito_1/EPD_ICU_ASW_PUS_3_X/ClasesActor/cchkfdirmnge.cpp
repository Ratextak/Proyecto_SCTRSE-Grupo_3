...
CCHKFDIRMng::CCHKFDIRMng(TEDROOMComponentID id,
...
void CCHKFDIRMng::EDROOMBehaviour()
{
...
bool CCHKFDIRMng::EDROOMIsComponentFinished()
{
...
void CCHKFDIRMng::CEDROOMMemory::SetMemory(TEDROOMUInt32 numMessages_ ,
